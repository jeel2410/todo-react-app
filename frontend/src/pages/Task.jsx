      ...
      <MainLayout>
        <form className='m-auto my-16 max-w-[1000px] bg-white p-8 border-2 shadow-md rounded-md'>
          {loading ? (
            ...
            <>
              <h2 className='text-center mb-4 bg-orange-500 text-white py-3'>{mode === "add" ? "Add New Task" : "Edit Task"}</h2>
              <div className="mb-4">
              ...
              <button className='bg-orange-500 text-white px-4 py-2 font-medium hover:bg-orange-500' onClick={handleSubmit}>{mode === "add" ? "Add task" : "Update Task"}</button>
